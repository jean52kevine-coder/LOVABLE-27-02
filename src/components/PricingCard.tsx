...
export const PricingCard = ({
  ...
  <div
    className={`relative bg-gradient-card rounded-2xl border border-glow p-8 flex flex-col card-lift ${
  ...
  >
    {badge && (
      <span className="absolute -top-3 left-1/2 -translate-x-1/2 px-4 py-1 rounded-full bg-gradient-primary text-xs font-body font-semibold text-foreground">
        {badge}
      </span>
    )}
